...
// WebBasicServiceImpl Web static service implement
type WebBasicServiceImpl struct {
...
func (bs *WebBasicServiceImpl) AfterInject() error {
	return nil
}

// ServeHome return the `home`
func (bs *WebBasicServiceImpl) ServeHome(ctx *gin.Context) {
	ctx.HTML(http.StatusOK, "global", gin.H{
		"Title": "binacs.cn - Home",
		"Body":  template.HTML(homeBody),
	})
}

// ServeToys return the `toys`
func (bs *WebBasicServiceImpl) ServeToys(ctx *gin.Context) {
	ctx.HTML(http.StatusOK, "global", gin.H{
		"Title": "binacs.cn - Toys",
		"Body":  template.HTML(toysBody),
	})
}

// ServeCrypto return the `toys/crypto`
func (bs *WebBasicServiceImpl) ServeCrypto(ctx *gin.Context) {
	ctx.HTML(http.StatusOK, "global", gin.H{
		"Title": "binacs.cn - Crypto",
		"Body":  template.HTML(cryptoBody),
	})
}

// ServeTinyURL return the `toys/tinyurl`
func (bs *WebBasicServiceImpl) ServeTinyURL(ctx *gin.Context) {
	ctx.HTML(http.StatusOK, "global", gin.H{
		"Title": "binacs.cn - TinyURL",
		"Body":  template.HTML(tinyurlBody),
	})
}

// ServePastebin return the `toys/pastebin`
func (bs *WebBasicServiceImpl) ServePastebin(ctx *gin.Context) {
	ctx.HTML(http.StatusOK, "global", gin.H{
		"Title": "binacs.cn - Pastebin",
		"Body":  template.HTML(pastebinBody),
	})
}

// ServeAbout return the `about`
func (bs *WebBasicServiceImpl) ServeAbout(ctx *gin.Context) {
	ctx.HTML(http.StatusOK, "global", gin.H{
		"Title": "binacs.cn - About",
		"Body":  template.HTML(aboutBody),
	})
}
...
<div class="section" style="height: 10vh;">
	<div class="row">
		<div class="col s12">whu - cyber security - algorithm - go - cpp - cloud native - blockchain</div>
	</div>
</div>
...
<div class="section" style="height: 10vh;">
	<div class="row">
		<div class="col s12">solutions - cryptology - pastebin - tinyurl - prometheus - grafana - jenkins - doscify</div>
	</div>
</div>
<div style="font-size: 14px; height: 40vh;">
...
<div class="section" style="height: 10vh;">
	<div class="row">
		<div class="col s12">密钥输入种类过于复杂 故暂使用服务器保留密钥 并随机使用Base64/AES/DES加解密</div>
	</div>
</div>
<div style="font-size: 12px;">
	<form id="form" class="row">
		<div class="input-field col s12">
			<textarea id="enc_source" class="materialize-textarea" maxlength="512"></textarea>
		...
		<div class="input-field col s12">
			<textarea id="dec_source" class="materialize-textarea" maxlength="512"></textarea>
...
<div class="section" style="height: 10vh;">
	<div class="row">
		<div class="col s12">默认使用md5算法</div>
	</div>
</div>
<div style="font-size: 12px;">
	<div class="row">
...
<div class="section" style="height: 10vh;">
	<div class="row">
		<div class="col s12">默认使用Markdown语法渲染</div>
	</div>
</div>
<div style="font-size: 12px;">
	<div class="row">
		<form class="col s12" name="pasteForm">
			<div class="row">
				<div class="input-field col s12">
					<textarea id="sub_content" class="materialize-textarea" maxlength="2048"></textarea>
	...
	<script type="text/javascript">
		function paste_submit() {
			$.ajax({
				'url': '/api/v1/pastebin/submit',
				'data': {
					"text": $('#sub_content').val(),
				},
				'type': 'post',
				'dataType': "text",
				'success': function(data) {
