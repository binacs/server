...
func (c *cosClient) CosBucketURL(ctx context.Context, in *CosBucketURLReq, opts ...grpc.CallOption) (*CosBucketURLResp, error) {
	...
	err := c.cc.Invoke(ctx, Cos_CosBucketURL_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cosClient) CosPut(ctx context.Context, in *CosPutReq, opts ...grpc.CallOption) (*CosPutResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CosPutResp)
	err := c.cc.Invoke(ctx, Cos_CosPut_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cosClient) CosGet(ctx context.Context, in *CosGetReq, opts ...grpc.CallOption) (*CosGetResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CosGetResp)
	err := c.cc.Invoke(ctx, Cos_CosGet_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedCosServer should be embedded to have
...
func (UnimplementedCosServer) CosBucketURL(context.Context, *CosBucketURLReq) (*CosBucketURLResp, error) {
	return nil, status.Error(codes.Unimplemented, "method CosBucketURL not implemented")
}
func (UnimplementedCosServer) CosPut(context.Context, *CosPutReq) (*CosPutResp, error) {
	return nil, status.Error(codes.Unimplemented, "method CosPut not implemented")
}
func (UnimplementedCosServer) CosGet(context.Context, *CosGetReq) (*CosGetResp, error) {
	return nil, status.Error(codes.Unimplemented, "method CosGet not implemented")
}
...
func RegisterCosServer(s grpc.ServiceRegistrar, srv CosServer) {
	// If the following call panics, it indicates UnimplementedCosServer was
